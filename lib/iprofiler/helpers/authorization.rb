module Iprofiler
  module Helpers
    ...
    module Authorization
      ...
      # Options:
      #   :oauth_callback => String, url that Iprofiler should redirect to
      def request_token(options={})
        @request_token ||= consumer.get_request_token(options)
      end

      # For web apps use params[:oauth_verifier], for desktop apps,
      # use the verifier is the pin that Iprofiler gives users.
      ...
      private
        ...
        # since Iprofiler uses api.linkedin.com for request and access token exchanges,
